	...
	<div class="body_box">
	 ...
	 <table cellpadding="0" cellspacing="0" class="table_list">
                  ...
                  <tr>
                    ...
                    <td>必须开启</td>
                    <td><?php if(extension_loaded('mysqli')){ ?><span><img src="images/correct.gif" /></span><?php }else{ ?><font class="red"><img src="images/error.gif" />&nbsp;无法安装</font><img title='请修改php.ini，去掉extension=php_mysqli.dll前的分号,重启apache' src='images/help.png'><?php }?></td>
                  </tr>
            ...
            <?php }else{ ?>
			<a onClick="alert('当前配置不满足单点CRM安装需求，无法继续安装！');" class="x_btn pre">检测不通过</a>
 			<?php }?>
