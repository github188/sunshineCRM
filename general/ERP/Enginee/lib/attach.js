...
function AddFile(file_type)
{
   ...
   attach_div.innerHTML+="<span id='"+prefix+"_span_"+id+"' title='"+file.value+"'><img src='../../Framework/images/attach/attach.png' align='absMiddle'>"+attach_name+"<img src='../../Framework/images/attach/remove.png' onclick='RemoveFile(this)' align='absMiddle' style='cursor:hand;'>;&nbsp;</span>";
   file.style.zIndex = "-1";
