	...
	if(key!=kword.value && kword.value!="")
	{
     key=kword.value;
	   ...
	   if($('search_icon').src.indexOf("/images/quicksearch.gif")>=0)
	   {
	   	   ...
	   	   $('search_icon').onclick=function(){kword.value='按房间号码搜索...';$('search_icon').src="<?php echo ROOT_DIR?>images/quicksearch.gif";$('search_icon').title="";$('search_icon').onclick=null;};
	   }
  }
...
if($_GET['action']=="SEARCH")	{
	...
	$AddSql = " where 房间号码 like '%$KEYVALUE%'";
}//print_R($_GET);

//print $AddSql;

echo "<table class=\"TableBlock trHover\" width=\"100%\">\r\n<tr class=\"TableHeader\">\r\n  <td align=\"center\"><b>选择单元</b></td>\r\n</tr>\r\n\r\n";

$sql = "select 房间号码 from wu_housingresources $AddSql order by 房间号码 ";
