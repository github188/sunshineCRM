...
if($_GET['action']=='dataDeal')		{
	require_once('dataDealStockOutPay.php');
	//print_R($db);
	if($_POST['dataDealMethod']=="update")	{
		dataDeal_edit();
		print "<META HTTP-EQUIV=REFRESH CONTENT='0;URL=stockoutpay_newai.php'>\n";
	}
	else	{
		dataDeal_add();
...
if($_GET['action']=='edit_default'&&$_GET['ROWID']!="")		{
	$sql = "select * from getmain where ROWID='".$_GET['ROWID']."'";
	$rs = $db->Execute($sql);
	$rs_a = $rs->GetArray();	//print_R($rs_a);
	//tablecode,tabledate,supplyid,getmentid,banckid,checkid,checkdate,currency,paymoney,getmainstate,ROWID,fillindate,state,user_id,factgetamt,checkamt,fileaddress
	$tablecode = $rs_a[0]['tablecode'];
	$tabledate = $rs_a[0]['tabledate'];
	$supplyid = $rs_a[0]['supplyid'];
	$getmentid = $rs_a[0]['getmentid'];
	$banckid = $rs_a[0]['banckid'];
	$checkid = $rs_a[0]['checkid'];
	$checkdate = $rs_a[0]['checkdate'];
	$currency = $rs_a[0]['currency'];
	$paymoney = $rs_a[0]['paymoney'];
	$getmainstate = $rs_a[0]['getmainstate'];
	$ROWID = $rs_a[0]['ROWID'];
	$fillindate = $rs_a[0]['fillindate'];
	$state = $rs_a[0]['state'];
	$user_id = $rs_a[0]['user_id'];
	$factgetamt = $rs_a[0]['factgetamt'];
	$checkamt = $rs_a[0]['checkamt'];
	$fileaddress = $rs_a[0]['fileaddress'];


	$sql = "select * from getdetail where mainrowid='".$_GET['ROWID']."'";
	$rs2 = $db->Execute($sql);
	$rs_a2 = $rs2->GetArray();	//print_R($rs_a2[0]);


	// Array ( [stockoutcode] => [receivecode] => [ordercode] => [productid] => LD001-02 [plannum] => 3 [stockoutfactnum] => 0 [price] => 111 [money] => 333 [requireplandetailsign] => 备注 [ROWID] => 5 [state] => 4 [stockouttype] => [toreturn] => [user_id] => [mainrowid] => 3 [standard] => [mode] => [dataState] => 0 [storenum] => 10.00 )
}
...
function toggleSetting(id) {
	...
	//var stockOutitButton = document.all["stockOutitButton"];
	if (div.style.display == "none") {
		div.style.display = "block";
		img.src = imgpath + "minus.gif";
		//stockOutitButton.style.display = "block";
	}
	else {
		div.style.display = "none";
		//stockOutitButton.style.display = "none";
...
//alert("numdotValue="+numdotValue);
 ...
 var fieldNum2="";
  ...
  URL="./DataQuery/amtquery_out.php?moduleId="+moduleId+"&fieldname="+fieldname+"&fieldValue="+fieldValue+"&codeValue="+codeValue+"&countStr="+countStr+"&cliNo="+cliNo+"&supplyId="+supplyId;
  //alert(URL);
   loc_x=354;
   loc_y=262;
...
function secamtaddnew()
{
   ...
   var idValue="id_stockoutid_id_1_wxdid_";
...
function check_query(field)
{
  fieldId=document.all(field).value;
  fieldRowId=document.all(field+"_ROWID").value;
  ModuleId=document.all("ModuleId").value;
  supplyid=document.all("supplyid").value;
  if (supplyid==null||supplyid==""){
  	alert("请先确定单位");
  	return;
  	}
  URL="getcheckindexxiaoshu.php?fieldId="+fieldId+"&fieldRowId="+fieldRowId+"&ModuleId="+ModuleId+"&supplyid="+supplyid;
  loc_x=document.body.scrollLeft+event.clientX-event.offsetX+350;
  loc_y=document.body.scrollTop+event.clientY-event.offsetY+100;
  window.showModalDialog(URL,self,"edge:raised;scroll:0;status:0;help:0;resizable:1;dialogWidth:780px;dialogHeight:450px;dialogTop:"+loc_y+"px;dialogLeft:"+loc_x+"px");
  //window.open(URL,"","menubar=0,toolbar=0,status=0,scrollbars=1,resizable=1,width=400px,height=300px,Top="+loc_y+"px,Left="+loc_x+"px");
}
...
<table width="95%" class="TableBlock">
  <tr>
    <td nowrap align="left" class="TableHeader" colspan="2">&nbsp;&nbsp;<b>销售付款管理      ：以下项目带*号的为必填项目</b></td>
    <td nowrap align="left" class="TableHeader" colspan="2">&nbsp</td>
  </tr>

   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>付款单编号&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <input  readonly type="text" name="tablecode" value="<?php echo returnDateAutoIncrement("tablecode","getmain");?>" size="10"  maxlength="50"   class="SmallInput">
<b>*</b>
       </td>

       <td nowrap width="100" align="right" class="TableContent"><b>付款日期&nbsp;</b></td>
       <td nowrap align="left" class="TableData">
...
<b>*</b>
   ...
   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>客户&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

          <input type="text" name="supplyid_NAME" readonly  value=""  class="SmallStatic">
		   ...
		   <input   type="hidden" name="user_id" value="<?php echo $_SESSION['SUNSHINE_USER_NAME']?>"size="20"  maxlength="50">
<b>*</b>
       </td>

       <td nowrap width="100" align="right" class="TableContent"><b>付款方式&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

      <?php
		print_select_single_select2("getmentid",'',"payment","code","name",$getmentid);
	?>
<b>*</b>
       </td>
   ...
   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>银行帐号&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <?php
		print_select_single_select2("bankid",'',"bank","bankid","bankname",$bankid);
	?>
<b>*</b>
       </td>

       <td nowrap width="100" align="right" class="TableContent"><b>支票号&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <input   type="text" name="checkid" size="10"  maxlength="50"   class="SmallInput" value="<?php echo $checkid?>">
   ...
   <tr>
       ...
       <td nowrap align="left" class="TableData">
          ...
          <input type="text" name="checkdate" value="<?php echo $checkdate?>" readonly  class="SmallStatic">
...
<b>*</b>
   ...
   <tr>
       ...
       <td nowrap align="left" class="TableData">
           ...
           <input   type="text" name="paymoney" size="10"  maxlength="50" onkeypress="check_input_num('MONEY')" value="<?php echo $paymoney?>" onfocus="init_value('paymoney')" onblur="check_value('paymoney')" class="SmallInput">
<b>*</b>
       </td>

       <td nowrap width="100" align="right" class="TableContent"><b>实际付款金额&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <input   type="text" name="factgetamt" size="10"  maxlength="50" onkeypress="check_input_num('MONEY')" onfocus="init_value('factgetamt')" value="<?php echo $factgetamt?>" onblur="check_value('factgetamt')" class="SmallInput">
   ...
   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>核销预付款金额&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

 <input type="hidden" name="checkamt_ROWID" >
 <input type="text" name="checkamt" readonly  class="SmallStatic" value="<?php echo $checkamt?>">
 <input type="button" name="b1" value="核销" class="SmallButton" onclick="check_query('checkamt');"  value="<?php echo $checkamt?>">

       </td>

       <td nowrap width="100" align="right" class="TableContent"><b>备注&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <input   type="text" name="getmainstate" size="10"  maxlength="50"   class="SmallInput"  value="<?php echo $getmainstate?>">

       </td>

   </tr>

      <input type="hidden" name="a_count" value="12">
      <input type="hidden" name="Add_fieldName" value=",tablecode,tabledate,supplyid,getmentid,banckid,checkid,checkdate,currency,paymoney,factgetamt,checkamt,getmainstate">
      <input type="hidden" name="Add_fieldType" value=",CHAR,DATE,CHAR,CHAR,CHAR,CHAR,DATE,CHAR,MONEY,MONEY,MONEY,DATE">
      <input type="hidden" name="Add_table" value="getmain">
      <input type="hidden" name="Add_url" value="buypay/stockoutpay/add.php">
      <input type="hidden" name="Back_url" value="buypay/stockoutpay/index.php">
      <input type="hidden" name="FLD_MUST_STR" value="tablecode,tabledate,supplyid,getmentid,banckid,currency,paymoney,">
      <input type="hidden" name="FLD_NAME_STR" value="付款单编号,付款日期,客户,付款方式,银行帐号,货币,总金额,">
...
<td nowrap width="100" align="center" class="TableContent"><b>出库单编号*</b></td>

<td nowrap width="100" align="center" class="TableContent"><b>总金额*</b></td>

<td nowrap width="100" align="center" class="TableContent"><b>已付金额*</b></td>

<td nowrap width="100" align="center" class="TableContent"><b>本次付款金额*</b></td>
...
<table width="95%" class="TableBlock">
 ...
 <td nowrap width="100" align="left" class="TableData">
            ...
            <input type="hidden" name="stockoutid_id<?php echo $MarkName?>" id="id_stockoutid_id_1_wxdid_<?php echo $MarkID?>">
            <input   type="text" id="id_stockoutid_1_wxd_<?php echo $MarkID?>"   name="stockoutid<?php echo $MarkName?>" size="10"  maxlength="50" onClick="dataClick('<?php echo $MarkID?>'); " class="SmallInput2" onkeypress="amtQuery('stockoutid','S08',<?php echo $MarkID?>);" ondblclick="amtQuery('stockoutid','S08',<?php echo $MarkID?>);">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input  readonly type="text" id="allpaymoney_<?php echo $MarkID?>" name="allpaymoney<?php echo $MarkName?>" size="10"  maxlength="50" onkeypress="check_input_num('MONEY')" onfocus="init_value_amt('allpaymoney_<?php echo $MarkID?>')" onblur="check_value_amt('allpaymoney_<?php echo $MarkID?>')" class="SmallInput2" >
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input  readonly type="text" id="haspaymoney_<?php echo $MarkID?>" name="haspaymoney<?php echo $MarkName?>" size="10"  maxlength="50" onkeypress="check_input_num('MONEY')" onfocus="init_value_amt('haspaymoney_<?php echo $MarkID?>')" onblur="check_value_amt('haspaymoney_<?php echo $MarkID?>')" class="SmallInput2" >
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text" id="thispaymoney_<?php echo $MarkID?>" name="thispaymoney<?php echo $MarkName?>" size="10"  maxlength="50" onkeypress="check_input_num('MONEY')" onfocus="init_value_amt('thispaymoney_<?php echo $MarkID?>')" onblur="check_value_amt('thispaymoney_<?php echo $MarkID?>')" class="SmallInput2" >
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text" id="paystate_<?php echo $MarkID?>" name="paystate<?php echo $MarkName?>" size="10"  maxlength="50"  onkeypress="insertRow();"
  class="SmallInput2" >
...
<div id="hiddenId">
      ...
      <input type="hidden" name="tempAmt" >
      <input type="hidden" name="actionStateId" value="4">
      <input type="hidden" name="s_count" value="5">
      <input type="hidden" name="dataCount" value="<?php echo $dataCount?>">
      <input type="hidden" name="ModuleId" value="S08">
      <input type="hidden" name="secAdd_fieldName" value=",stockoutid,allpaymoney,haspaymoney,thispaymoney,paystate">
      <input type="hidden" name="secAdd_fieldType" value=",CHAR,MONEY,MONEY,MONEY,DATE">
      <input type="hidden" name="secAdd_table" value="getdetail">
      <input type="hidden" name="secFLD_MUST_STR" value="stockoutid,allpaymoney,haspaymoney,thispaymoney,">
      <input type="hidden" name="secFLD_NAME_STR" value="出库单编号,总金额,已付金额,本次付款金额,">
      <input type="hidden" name="hidDataNo" >
</div>
</form>
<input type="button" name="btnsave" id="btnsave" class="SmallButton" value="添加明细" onClick="javascript:clickInsertRow();">&nbsp;&nbsp;&nbsp;
<input type="button" name="btnsave" id="btnsave" class="SmallButton" value="删除明细" onClick="javascript:clickDeleteRow() ;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input type="button" name="btnsave" id="btnsave" class="SmallButton" value="保存" onClick="javascript:secamtaddnew() ;">&nbsp;&nbsp;&nbsp;
  <input type="reset" name="btnlist" id="btnlist" class="SmallButton" value="重置">&nbsp;&nbsp;&nbsp;
  <INPUT class=SmallButton id=close onclick="location='stockoutpay_newai.php'" type=button value=返回 name=close>
 <br>
  本页面执行时间: <script>
 var now1 =new Date()
...
<div id="hiddenDataId">
<table border="0" cellspacing="1" width="95%" class="small" bgcolor="#000000" cellpadding="3"  style="display:none" >
 <tr>
 <td nowrap width="40" align="center" class="TableContent">
 ...
 <td nowrap width="100" align="left" class="TableData">
            ...
            <input type="hidden" name="stockoutid_id_dxw" id="id_stockoutid_id_1_wxdid_1">
            <input   type="text" id="id_stockoutid_1_wxd_1"   name="stockoutid_dxw" size="10"  maxlength="50"  onClick="dataClick('1'); "  class="SmallInput2" onkeypress="amtQuery('stockoutid','S08',1);"  ondblclick="amtQuery('stockoutid','S08',1);">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input  readonly type="text"  id="allpaymoney_dxw"  name="allpaymoney_dxw" size="10"  maxlength="50" onkeypress="check_input_num('MONEY')" onfocus="init_value_amt('allpaymoney_dxw')" onblur="check_value_amt('allpaymoney_dxw')" class="SmallInput2">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input  readonly type="text"  id="haspaymoney_dxw"  name="haspaymoney_dxw" size="10"  maxlength="50" onkeypress="check_input_num('MONEY')" onfocus="init_value_amt('haspaymoney_dxw')" onblur="check_value_amt('haspaymoney_dxw')" class="SmallInput2">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text"  id="thispaymoney_dxw"  name="thispaymoney_dxw" size="10"  maxlength="50" onkeypress="check_input_num('MONEY')" onfocus="init_value_amt('thispaymoney_dxw')" onblur="check_value_amt('thispaymoney_dxw')" class="SmallInput2">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text"  id="paystate_dxw"  name="paystate_dxw" size="10"  maxlength="50"  onkeypress="insertRow();"
  class="SmallInput2">
