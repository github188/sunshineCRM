<?php
	...
	*/
	...
	//数据表模型文件,对应Model目录下面的sellplanmain_detail_newai.ini文件
	//如果是需要复制此模块,则需要修改$parse_filename参数的值,然后对应到Model目录 新文件名_newai.ini文件
	$SYSTEM_ADD_SQL=" and mainrowid in (select billid from sellplanmain where user_flag>=1)";
	$filetablename		=	'sellplanmain_detail';
	$parse_filename		=	'sellplanmain_detail';
