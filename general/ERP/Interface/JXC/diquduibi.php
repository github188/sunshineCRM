...
chart_index.setDataXML("<graph bgcolor='e1f5ff' caption='地区对比' subCaption='精确到百位（四舍五入）' numberPrefix='' formatNumberScale='1' decimalPrecision='2' baseFontSize='14' numberSuffix='万元'><?php foreach ($rs_a as $row){echo "<set name='".$row['name']."' value='".($row['sum']/10000)."'/>";}?></graph>");
