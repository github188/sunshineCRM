...
$sql = "select * from sellplanamt where CustomerId='$supplyid'";
$rs = $db->Execute($sql);
$rs_a = $rs->GetArray();
//  tablecode tabledate PlanNo CustomerId PlanUser planamt checkamt lastamt explainstr ROWID user_id fileaddress curr
?>
 ...
 function stockBack(num)
{
    ...
    RowIdStr=RowIdStr+document.all("1"+i).value+":"+backNum+",";
    }
    }
    if (countNum==0){
    alert("请确定本次核销"+'预付款'+"金额!");
    return (false);
    }
//alert(RowIdStr);
//alert(countNum);
parent_window.document.all("checkamt_ROWID").value=RowIdStr;
parent_window.document.all("checkamt").value=countNum;
//alert(parent_window.document.all("checkamt_ROWID").value);
//alert(parent_window.document.all("checkamt").value);
   //form1.flag.value="checkBuyPlan";
   //form1.submit();
   window.close();
}
function checkNum(numNo)
{
    ...
    var num1=document.form1("5"+numNo).value;//预收款
    var numCount=document.form1("num").value;//总行数
    var num2=document.form1("6"+numNo).value; //已核销金额
    ...
    if (lastNum<parseFloat(numIn)){
     if(window.confirm("本次核销"+'预付款'+"金额大于"+'预付款'+"金额,是否继续进行？"))
     {
...
<tr align="center" >
      ...
      <td nowrap  class="TableHeader" >供货商</td>

      <td nowrap  class="TableHeader" >编号</td>

      <td nowrap  class="TableHeader" >日期</td>

      <td nowrap  class="TableHeader" >付款人</td>

      <td nowrap  class="TableHeader" >订单号</td>

      <td nowrap  class="TableHeader" >预付款金额</td>

      <td nowrap  class="TableHeader" >已核销金额</td>

<td nowrap  class="TableHeader" >本次核销预付款金额</td>
</tr>

<?php
$supplyName = returntablefield("customer","supplyid",$supplyid,"supplyname");;
//print_R($rs_a);
for($i=0;$i<sizeof($rs_a);$i++)		{
	$Element = $rs_a[$i];
	$supplyId = $Element['CustomerId'];
	$All_planamt += $Element['planamt'];
	$All_checkamt += $Element['checkamt'];
	$ii = $i+1;
	$iii = $i+14;
//  tablecode tabledate PlanNo CustomerId PlanUser planamt checkamt lastamt explainstr ROWID user_id fileaddress curr
...
<tr class="TableLine1" id="TR<?php echo $iii?>" >

<td   align="left" ><input readonly  type="text"   name="0<?php echo $ii?>" value="<?php echo $supplyName?>" size="25" maxlength="54"  class="SmallStatic"></td>

<td   align="left" ><input readonly  type="text"   name="1<?php echo $ii?>" value="<?php echo $Element['tablecode'];?>" size="10" maxlength="54"  class="SmallStatic"></td>

<td   align="left" ><input readonly  type="text"   name="2<?php echo $ii?>" value="<?php echo $Element['tabledate'];?>" size="10" maxlength="54"  class="SmallStatic"></td>

<td   align="left" ><input readonly  type="text"   name="3<?php echo $ii?>" value="<?php echo $Element['PlanUser'];?>" size="10" maxlength="54"  class="SmallStatic"></td>

<td   align="left" ><input readonly  type="text"   name="4<?php echo $ii?>" value="<?php echo $Element['PlanNo'];?>" size="10" maxlength="54"  class="SmallStatic"></td>

<td   align="right" ><input readonly  type="text"   name="5<?php echo $ii?>" value="<?php echo $Element['planamt'];?>" size="10" maxlength="54"  class="SmallStatic"></td>

<td   align="right" ><input readonly  type="text"   name="6<?php echo $ii?>" value="<?php echo $Element['checkamt'];?>" size="10" maxlength="54"  class="SmallStatic"></td>

<td  ><input   type="text"   name="backnum<?php echo $ii?>" size="10" maxlength="54"  onblur="checkNum('<?php echo $ii?>')"  class="SmallInput"></td>
</tr>
<input type="hidden" name="ROWID_<?php echo $ii?>" value="<?php echo $iii?>">
...
<td  class="TableHeader" align="right"><?php echo $All_planamt?></td>

<td  class="TableHeader" align="right"><?php echo $All_checkamt?></td>

<td class="TableHeader" align="left">&nbsp</td>
</tr>
</table>
<input   type="hidden"   name="countNum" >
<input type="hidden" name="num" value="2">
<input type="hidden" name="RowIdStr" >
<input type="hidden" name="ModuleId" value="B09">
<input type="hidden" name="flag">
 </form>
<br>
<input type="button" name="close" id="close" class="SmallButton" value="保存" onClick="javascript:stockBack('<?php echo $ii?>');">
