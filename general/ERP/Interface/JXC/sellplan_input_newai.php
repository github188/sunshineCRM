...
if($_GET['action']=='dataDeal')		{
	//print_R($_GET);
	//print_R($_POST);//exit;
	require_once('dataDealSellPlan.php');
	//print_R($db);
	if($_POST['dataDealMethod']=="update")	{
		dataDeal_edit();
		print "<META HTTP-EQUIV=REFRESH CONTENT='0;URL=sellplan_newai.php'>\n";
	}
	else	{
		dataDeal_add();
...
if($_GET['action']=='edit_default'&&$_GET['ROWID']!="")		{
	$sql = "select * from sellplanmain where ROWID='".$_GET['ROWID']."'";
	$rs = $db->Execute($sql);
	$rs_a = $rs->GetArray();	//print_R($rs_a);

	$Columns = returntablecolumn("sellplanmain");
	for($i=0;$i<sizeof($Columns);$i++)		{
		$Element = $Columns[$i];
		$$Element = $rs_a[0][$Element];
	}

	$sql = "select * from sellplandetail where mainrowid='".$_GET['ROWID']."'";
	$rs2 = $db->Execute($sql);
...
function query_supply(field)
{
  ...
  loc_x=document.body.scrollLeft+event.clientX-event.offsetX+350;
  loc_y=document.body.scrollTop+event.clientY-event.offsetY+100;
  window.showModalDialog(URL,self,"edge:raised;scroll:0;status:0;help:0;resizable:1;dialogWidth:550px;dialogHeight:300px;dialogTop:"+loc_y+"px;dialogLeft:"+loc_x+"px");
  //window.open(URL,"","menubar=0,toolbar=0,status=0,scrollbars=1,resizable=1,width=400px,height=300px,Top="+loc_y+"px,Left="+loc_x+"px");
}
...
<table width="95%" class="TableBlock">
  <tr>
    <td nowrap align="left" class="TableHeader" style="Height:25" colspan="4">&nbsp;<b>销售订单管理      ：以下项目带*号的为必填项目</b></td>

  </tr>

   <tr>
       <td nowrap  width="15%" align="right" class="TableContent"><b>编号&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">

           <input  readonly type="text" name="tablecode" value="<?php echo returnDateAutoIncrement("tablecode","sellplanmain",$tablecode);?>" size="15"  maxlength="50"   class="SmallInput">
<b>*</b>
       </td>

       <td nowrap width="15%" align="right" class="TableContent"><b>订单日期&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">
...
<b>*</b>
       ...
       <td nowrap width="15%" align="right" class="TableContent"><b>订单金额&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">

           <input  readonly type="text" name="amt" value="<?php echo $amt?>"  value="<?php echo $amt?>" size="15"  maxlength="50" onkeypress="check_input_num('MONEY')" onfocus="init_value('amt')" onblur="check_value('amt')" class="SmallInput">
...
<table width="95%" class="TableBlock">
  <tr>
    <td nowrap align="left" class="TableHeader" style="Height:25">
    <a href='javascript:toggleSetting("block1");'><img id="block1_tgimg" hspace="2" src="images/minus.gif" border="0" align="absmiddle"><b>扩展项目区</b></a>&nbsp;&nbsp;
  </tr>
</table>

  <div id="block1" style="display:hand;" class="small">
<table width="95%" class="TableBlock">


   <tr>
       <td nowrap width="15%" align="right" class="TableContent"><b>销售部门&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">
...
<b>*</b>
       ...
       <td nowrap width="15%" align="right" class="TableContent"><b>计划收款&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">
   ...
   <tr>
	...
	?>
       ...
       <td nowrap width="35%" align="left" class="TableData">
           ...
           <input   type="text" name="payamt" value="<?php echo $payamt?>" size="15"  value="<?php echo $payamt?>" maxlength="50" onkeypress="check_input_num('MONEY')" onfocus="init_value('payamt')" onblur="check_value('payamt')" class="SmallInput">
   ...
   <tr>
       <td nowrap width="15%" align="right" class="TableContent"><b>项目&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">

           <input   type="text" name="stockinsign" value="<?php echo $stockinsign?>" size="15"  value="<?php echo $stockinsign?>" maxlength="50"   class="SmallInput">

       </td>

       <td nowrap width="15%" align="right" class="TableContent"><b>折扣&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">

           <input   type="text"  value="10" name="rebate"  value="<?php echo $rebate?>" size="10"  maxlength="50" onkeypress="check_input_num('NUMBER')" onblur="checkRate('rebate'); " class="SmallInput">
<b>*</b>
       </td>
 ...
 <?php
 if($sendDate=="")		{
	$sendDate = date("Y-m-d",mktime(1,1,1,date("m"),date("d")+5,date("Y")));
 }


 ?>
       <td nowrap width="15%" align="right" class="TableContent"><b>预计送货日期&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">

          <input type="text" name="sendDate" value="<?php echo $sendDate?>" readonly  class="SmallStatic">
          <input type="button" name="b1" value="浏览" class="SmallButton" onclick="query_date('sendDate');">
   ...
   <tr>
       <td nowrap width="15%" align="right" class="TableContent"><b>客订单号&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">
			<?php
				if($customerPO=="")		{
					$customerPO = returnDateAutoIncrement("tablecode","sellplanmain",$tablecode);
				}
			?>
           <input   type="text" name="customerPO" value="<?php echo $customerPO?>" size="20"  maxlength="50"   class="SmallInput">
<b>*</b>
       </td>
...
<input type="hidden" name="a_count" value="13">
      <input type="hidden" name="Add_fieldName" value=",tablecode,tabledate,supplyid,amt,stockid,factpayamt,intype,payamt,stockinsign,rebate,buyman,sendDate,customerPO">
      <input type="hidden" name="Add_fieldType" value=",CHAR,DATE,CHAR,MONEY,CHAR,MONEY,CHAR,MONEY,CHAR,NUMBER,CHAR,DATE,CHAR">
      <input type="hidden" name="Add_table" value="sellplanmain">
      <input type="hidden" name="Add_url" value="sellplan/add.php">
      <input type="hidden" name="Back_url" value="sellplan/index.php">
      <input type="hidden" name="FLD_MUST_STR" value="tablecode,tabledate,supplyid,stockid,rebate,customerPO,">
      <input type="hidden" name="FLD_NAME_STR" value="编号,订单日期,客户,销售部门,折扣,客订单号,">
      <input type="hidden" name="ModuleId" value="B04">
...
<td nowrap width="150" align="center" class="TableContent"><b>商品名称*</b></td>
...
<td nowrap width="100" align="center" class="TableContent"><b>订单数量*</b></td>
...
<table width="95%" class="TableBlock">
 ...
 <td nowrap width="150" align="left" class="TableData">
            ...
            <input title="请选择商品....."  type="text" id="id_productid_1_wxd_<?php echo $MarkID?>"   name="productid<?php echo $MarkName?>" value="<?php echo returntablefield("product","productid",$productid,"productname");?>" size="15"  maxlength="53" onClick="dataClick('<?php echo $MarkID?>'); " class="SmallInput2" onkeypress="dataQuery('productid','B04',<?php echo $MarkID?>);"  ondblclick="dataQuery('productid','B04',<?php echo $MarkID?>);">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text" id="standard_<?php echo $MarkID?>" name="standard<?php echo $MarkName?>" value="<?php echo $standard?>" size="10"  maxlength="50"  onkeypress="insertRow();" class="SmallInput2" >
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text" id="sellplandetailsign_<?php echo $MarkID?>" name="sellplandetailsign<?php echo $MarkName?>" value="<?php echo $sellplandetailsign?>" size="10"  maxlength="58"  onkeypress="insertRow();" class="SmallInput2" >
...
<div id="hiddenId">
      ...
      <input type="hidden" name="flagState"  value="">
      <input type="hidden" name="s_count" value="7">
      <input type="hidden" name="dataCount" value="<?php echo $dataCount?>">
      <input type="hidden" name="StockOutType" value="4">
      <input type="hidden" name="secAdd_fieldName" value=",productid,standard,mode,plannum,price,money,sellplandetailsign">
      <input type="hidden" name="secAdd_fieldType" value=",CHAR,CHAR,CHAR,NUMBER,MONEY,MONEY,CHAR">
      <input type="hidden" name="secAdd_table" value="sellplandetail">
      <input type="hidden" name="secFLD_MUST_STR" value="productid,standard,mode,plannum,">
      <input type="hidden" name="secFLD_NAME_STR" value="商品名称,规格,型号,订单数量,">
...
<input type="button" name="btnsave" id="btnsave" class="SmallButton" value="删除明细" onClick="javascript:clickDeleteRow() ;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <INPUT class=SmallButton id=close onclick="location='sellplan_newai.php'" type=button value=返回 name=close>
 <br>
...
<table border="0" cellspacing="1" width="95%" class="TableBlock"   style="display:none" >
 ...
 <td nowrap width="150" align="left" class="TableData">
            ...
            <input type="hidden" name="productid_id_dxw" id="id_productid_id_1_wxdid_1">
            <input type="hidden" name="productid_num_dxw" id="num_productid_id_1_wxdnum_1">
            <input type="hidden" name="productid_rate_dxw" id="num_productid_id_1_wxdrate_1">
            <input  title="请选择商品....."   type="text" id="id_productid_1_wxd_1"   name="productid_dxw" size="15"  maxlength="53"  onClick="dataClick('1'); "  class="SmallInput2" onkeypress="dataQuery('productid','B04',1);"  ondblclick="dataQuery('productid','B04',1);">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text"  id="standard_dxw" name="standard_dxw" size="10" maxlength="50"   onkeypress="insertRow();"
 class="SmallInput2">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text"  id="mode_dxw" name="mode_dxw" size="10" maxlength="50"   onkeypress="insertRow();"
 class="SmallInput2">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text" id="plannum_dxw" name="plannum_dxw" size="10"  maxlength="54" onkeypress="check_input_num('NUMBER')"onfocus="init_value_order('price_dxw')"  onblur="check_value_order('price_dxw')" class="SmallInput2" >
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text"  id="price_dxw" name="price_dxw" size="10" maxlength="56"  onkeypress="check_input_num('MONEY')"onfocus="init_value_order('price_dxw')" onblur="check_value_order('price_dxw')" class="SmallInput2">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input  readonly type="text"  id="money_dxw" name="money_dxw" size="10" maxlength="57"  onkeypress="check_input_num('MONEY')"onfocus="init_value_order('money_dxw')" onblur="check_value_order('money_dxw')" class="SmallInput2">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text"  id="sellplandetailsign_dxw" name="sellplandetailsign_dxw" size="10" maxlength="58"   onkeypress="insertRow();"
 class="SmallInput2">
