...
$sql = "select * from buyplanamt where SupplyId='$supplyid'";
$rs = $db->Execute($sql);
$rs_a = $rs->GetArray();
//  tablecode tabledate PlanNo SupplyId PlanUser planamt checkamt lastamt explainstr ROWID user_id fileaddress curr
?>
...
<?php
$supplyName = returntablefield("supply","supplyid",$supplyid,"supplyname");;
//print_R($rs_a);
...
<td   align="left" ><input readonly  type="text"   name="0<?php echo $ii?>" value="<?php echo $supplyName?>" size="15" maxlength="54"  class="SmallStatic"></td>
