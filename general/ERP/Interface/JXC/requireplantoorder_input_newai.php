...
function  getRequirePlan()
{
   ...
   var sendDate=document.form1("sendDate").value;
   var stockinsign=document.form1("stockinsign").value;
   var payamt=document.form1("payamt").value;
  URL="getrequireplan_index.php?supplyId="+supplyId+"&ModuleId="+ModuleId+"&tablecode="+tablecode+"&tabledate="+tabledate+"&stockid="+stockid+"&buyman="+buyman+"&intype="+intype+"&sendDate="+sendDate+"&stockinsign="+stockinsign+"&payamt="+payamt;
   loc_x=60;
   loc_y=100;
  //alert(URL);
  //window.showModalDialog(URL,self,"edge:raised;scroll:0;status:0;help:0;resizable:1;dialogWidth:700px;dialogHeight:300px;dialogTop:"+loc_y+"px;dialogLeft:"+loc_x+"px");
...
<table width="95%" class="TableBlock">
  <tr>
    <td nowrap align="left" class="TableHeader" colspan="2">&nbsp;&nbsp;<b>采购计划单据生成采购订单单据管理      ：以下项目带*号的为必填项目</b></td>
   ...
   <tr>
       ...
       <td nowrap align="left" class="TableData">
           ...
           <input  readonly type="text" name="tablecode" value="<?php echo returnDateAutoIncrement("tablecode","requireplanmain");?>" size="15"  maxlength="50"   class="SmallInput">
<b>*</b>
       </td>

       <td nowrap width="100" align="right" class="TableContent"><b>制作日期&nbsp;</b></td>
       <td nowrap align="left" class="TableData">
...
<b>*</b>
   ...
   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>厂商&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <input type="text" name="supplyid_NAME" readonly  value="<?php echo $supplyname=returntablefield("supply","supplyid",$supplyid,"supplyname");?>"  class="SmallStatic">
...
<b>*</b>
   ...
   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>订单类型&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

	<?php
		print_select_single_select2("intype",'03',"requiretype","id","name");
	?>
   ...
   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>预计到货日期&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

          <input type="text" name="sendDate" value="<?php echo date("Y-m-d")?>" readonly  class="SmallStatic">
          <input type="button" name="b1" value="浏览" class="SmallButton" onclick="query_date('sendDate');">

       </td>

       <td nowrap width="100" align="right" class="TableContent"><b>发票编号&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <input   type="text" name="invoice" size="15"  maxlength="50"   class="SmallInput">
      ...
      <input type="hidden" name="Add_fieldName" value=",tablecode,tabledate,supplyid,stockid,amt,factpayamt,intype,payamt,stockinsign,buyman,sendDate,invoice">
      <input type="hidden" name="Add_fieldType" value=",CHAR,DATE,CHAR,CHAR,MONEY,MONEY,CHAR,MONEY,CHAR,CHAR,DATE,CHAR">
      <input type="hidden" name="Add_table" value="buyplanmain">
      <input type="hidden" name="Add_url" value="requireplantoorder/add.php">
      <input type="hidden" name="Back_url" value="requireplantoorder/index.php">
      <input type="hidden" name="FLD_MUST_STR" value="tablecode,tabledate,supplyid,stockid,">
      <input type="hidden" name="FLD_NAME_STR" value="编号,制作日期,厂商,需求部门,">
      <input type="hidden" name="ModuleId" value="B01">
...
<div id="hiddenId">
      ...
      <input type="hidden" name="dataCount" value="">
...
<input type="button" name="btnsave" id="btnsave" class="SmallButton" value="选择采购计划" onClick="javascript:getRequirePlan();">&nbsp;&nbsp;&nbsp;
...
systemhelpContent("采购订单生成管理",'100%');
?>
