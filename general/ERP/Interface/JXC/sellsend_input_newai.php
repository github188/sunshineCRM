...
if($_GET['action']=='dataDeal')		{
	require_once('dataDealSellSend.php');
	//print_R($db);
	if($_POST['dataDealMethod']=="update")	{
		dataDeal_edit();
		print "<META HTTP-EQUIV=REFRESH CONTENT='0;URL=sellsend_newai.php'>\n";
	}
	else	{
		dataDeal_add();
...
if($_GET['action']=='edit_default'&&$_GET['ROWID']!="")		{
	$sql = "select * from sendmain where ROWID='".$_GET['ROWID']."'";
	$rs = $db->Execute($sql);
	$rs_a = $rs->GetArray();	//print_R($rs_a);

	$Columns = returntablecolumn("sendmain");
	for($i=0;$i<sizeof($Columns);$i++)		{
		$Element = $Columns[$i];
		$$Element = $rs_a[0][$Element];
	}

	$sql = "select * from senddetail where mainrowid='".$_GET['ROWID']."'";
	$rs2 = $db->Execute($sql);
	$rs_a2 = $rs2->GetArray();	//print_R($rs_a);
...
function query_supply(field)
{
  ...
  table=document.all(field+"_TABLE").value;
  ModuleId=document.all("ModuleId").value;
  URL="../../Framework/frame_depart_notify.php?title=选择记录&tablename=customer&fieldid=supplyid&fieldname=supplyname&field="+field+"&field2="+field+"_NAME&INIT_VALUE="+init_value+"";
  loc_x=document.body.scrollLeft+event.clientX-event.offsetX+350;
  loc_y=document.body.scrollTop+event.clientY-event.offsetY+100;
  window.showModalDialog(URL,self,"edge:raised;scroll:0;status:0;help:0;resizable:1;dialogWidth:750px;dialogHeight:450px;dialogTop:"+loc_y+"px;dialogLeft:"+loc_x+"px");
  //window.open(URL,"","menubar=0,toolbar=0,status=0,scrollbars=1,resizable=1,width=400px,height=300px,Top="+loc_y+"px,Left="+loc_x+"px");
...
function outProduct(countStr){
  ...
  var supplyId=document.form1("supplyid").value;
  var stockId=document.all("stockId").value;
  //var fieldValue=document.form1("id_productid_1_wxd_"+cliNo).value;
  var codeValue=document.form1("id_productid_id"+"_1_wxdid_"+cliNo).value;
 //
...
<table width="95%" class="TableBlock">
  <tr>
    <td nowrap align="left" class="TableHeader" style="Height:25" colspan="4">&nbsp;<b>送货管理      ：以下项目带*号的为必填项目</b></td>

  </tr>

   <tr>
       <td nowrap width="15%" align="right" class="TableContent"><b>出勤单编号&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">

           <input  readonly type="text" name="tablecode" value="<?php echo returnDateAutoIncrement("tablecode","sendmain",$tablecode);?>" size="15"  maxlength="50"   class="SmallInput">
<b>*</b>
       </td>

       <td nowrap width="15%" align="right" class="TableContent"><b>出勤日期&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">

          <input type="text" name="tabledate" value="<?php echo $tabledate?>" readonly  class="SmallStatic">
...
<b>*</b>
   ...
   <tr>
       <td nowrap width="15%" align="right" class="TableContent"><b>客户&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">

           <input type="text" name="supplyid_NAME" readonly  value="<?php echo returntablefield("customer","supplyid",$supplyid,"supplyname")?>"   class="SmallStatic">
           <input type="hidden" name="supplyid" value="<?php echo $supplyid?>">
           <input type="hidden" name="supplyid_CODE" value="1">
           <input type="hidden" name="supplyid_TABLE" value="customer">
           <input type="button" name="b1" value="查询" class="SmallButton" onclick="query_supply('supplyid');">
<b>*</b>
       </td>

       <td nowrap width="15%" align="right" class="TableContent"><b>仓库名称&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">

           <select name="stockid"  class="SmallSelect">


      <option value="10"  >成品库</option>

      <option value="11"  >|--半成品库</option>

      <option value="13"  >|--备品库</option>

      <option value="12"  >原料库</option>

      <option value="14"  >测试仓库</option>

      <option value="15"  >测试库</option>

      <option value="16"  >测试库2</option>

      <option value="17"  >测试库3</option>
...
<b>*</b>
   ...
   <tr>
       <td nowrap width="15%" align="right" class="TableContent"><b>总金额&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">

           <input  readonly type="text" name="amt"  value="<?php echo $amt?>" size="15"  maxlength="50" onkeypress="check_input_num('MONEY')" onfocus="init_value('amt')" onblur="check_value('amt')" class="SmallInput">

       </td>

       <td nowrap width="15%" align="right" class="TableContent"><b>应收款金额&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">

           <input   type="text" name="factpayamt"  value="<?php echo $factpayamt?>" size="15"  maxlength="50" onkeypress="check_input_num('MONEY')" onfocus="init_value('factpayamt')" onblur="check_value('factpayamt')" class="SmallInput">
   ...
   <tr>
       <td nowrap width="15%" align="right" class="TableContent"><b>送货类型&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">

	<?php
		print_select_single_select2("sendtype",'',"transport","id","name",$sendtype);
	?>

       </td>

       <td nowrap width="15%" align="right" class="TableContent"><b>实际收款金额&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">

           <input   type="text" name="payamt" value="<?php echo $payamt?>" size="15"  maxlength="50" onkeypress="check_input_num('MONEY')"  value="<?php echo $payamt?>" onfocus="init_value('payamt')" onblur="check_value('payamt')" class="SmallInput">
   ...
   <tr>
       <td nowrap width="15%" align="right" class="TableContent"><b>备注&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">

           <input   type="text" name="stockoutsign" size="15" value="<?php echo $stockoutsign?>"  maxlength="50"   class="SmallInput">
   ...
   <tr>
	...
	?>
       ...
       <td nowrap width="35%" align="left" class="TableData">
		 ...
		 <input   type="text" name="sellman_NAME" value="<?php echo returntablefield("user","USER_NAME",$sellman,"NICK_NAME");?>" size="15"  maxlength="50"   onclick="query_user('sellman');"  class="SmallInput">
		   <input   type="hidden" name="sellman" value="<?php echo $sellman?>" size="15"  maxlength="50">
		   <input   type="hidden" name="stockinpersion" value="<?php echo $_SESSION['SUNSHINE_USER_NAME']?>"size="15"  maxlength="50">
   ...
   <tr>
       <td nowrap width="15%" align="right" class="TableContent"><b>原始编号&nbsp;</b></td>
       <td nowrap width="35%" align="left" class="TableData">

           <input   type="text" name="tableNo" size="15" value="<?php echo $tableNo?>" maxlength="50"   class="SmallInput">

       </td>

       <td nowrap width="15%" align="right" class="TableContent">&nbsp</b></td>
       <td nowrap width="35%" align="left" class="TableData">&nbsp</td>
  ...
  <div id="block1" style="display:none;" class="small">
<table width="95%" class="TableBlock">
...
<div id="block2" style="display:none;" class="small">
<table width="95%" class="TableBlock">
 ...
 <input type="hidden" name="a_count" value="13">
      <input type="hidden" name="Add_fieldName" value=",tablecode,tabledate,supplyid,stockid,amt,factpayamt,sendtype,payamt,stockoutsign,payment,serviceman,sellman,tableNo">
      <input type="hidden" name="Add_fieldType" value=",CHAR,DATE,CHAR,CHAR,MONEY,MONEY,CHAR,MONEY,CHAR,CHAR,CHAR,CHAR,CHAR">
      <input type="hidden" name="Add_table" value="sendmain">
      <input type="hidden" name="Add_url" value="sellsend/add.php">
      <input type="hidden" name="Back_url" value="sellsend/index.php">
      <input type="hidden" name="FLD_MUST_STR" value="tablecode,tabledate,supplyid,stockid,">
      <input type="hidden" name="FLD_NAME_STR" value="出勤单编号,出勤日期,客户,仓库名称,">
      <input type="hidden" name="ModuleId" value="S14">
...
<table width="95%" class="TableBlock">
 <tr>
 <td nowrap width="40" align="center" class="TableContent"><b>序号</b></td>

<td nowrap width="100" align="center" class="TableContent"><b>商品名称*</b></td>

<td nowrap width="100" align="center" class="TableContent"><b>规格*</b></td>

<td nowrap width="100" align="center" class="TableContent"><b>型号*</b></td>

<td nowrap width="100" align="center" class="TableContent"><b>送货数量*</b></td>

<td nowrap width="100" align="center" class="TableContent"><b>单价</b></td>

<td nowrap width="100" align="center" class="TableContent"><b>金额</b></td>

<td nowrap width="100" align="center" class="TableContent"><b>备注</b></td>

<td nowrap width="100" align="center" class="TableContent"><b>赠品数量</b></td>

<td nowrap width="100" align="center" class="TableContent"><b>合计数量</b></td>
...
<table width="95%" class="TableBlock">
 ...
 <input  type="hidden" name="dataNo" value="<?php echo $MarkID?>" >
 <b><?php echo $MarkID?></b>
 </td>


 <td nowrap width="100" align="left" class="TableData">

            <input type="hidden" name="productid_id<?php echo $MarkName?>" value="<?php echo $productid_id?>" id="id_productid_id_1_wxdid_<?php echo $MarkID?>">
            <input type="hidden" name="productid_num<?php echo $MarkName?>" id="num_productid_id_1_wxdnum_<?php echo $MarkID?>">
            <input type="hidden" name="productid_rate<?php echo $MarkName?>" id="num_productid_id_1_wxdrate_<?php echo $MarkID?>">
            <input title="请选择商品....."  type="text" id="id_productid_1_wxd_<?php echo $MarkID?>"   name="productid<?php echo $MarkName?>" value="<?php echo returntablefield("product","productid",$productid,"productname");?>" size="10"  maxlength="53" onClick="dataClick('<?php echo $MarkID?>'); " class="SmallInput2" onkeypress="dataQuery('productid','S14',<?php echo $MarkID?>);"  ondblclick="dataQuery('productid','S14',<?php echo $MarkID?>);">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text" id="standard_<?php echo $MarkID?>" name="standard<?php echo $MarkName?>" value="<?php echo $storenum?>" size="10"  maxlength="50"  onkeypress="insertRow();" class="SmallInput2" >
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text" id="mode_<?php echo $MarkID?>" name="mode<?php echo $MarkName?>" value="<?php echo $mode?>" size="10"  maxlength="50"  onkeypress="insertRow();" class="SmallInput2" >
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text" id="plannum_<?php echo $MarkID?>" name="plannum<?php echo $MarkName?>" value="<?php echo $plannum?>" size="10"  maxlength="54" onkeypress="check_input_num('NUMBER')"onfocus="init_value_order('price_<?php echo $MarkID?>')"  onblur="check_value_order('price_<?php echo $MarkID?>')" class="SmallInput2" >
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text" id="price_<?php echo $MarkID?>" name="price<?php echo $MarkName?>" value="<?php echo $price?>" size="10"  maxlength="56" onkeypress="check_input_num('MONEY')"onfocus="init_value_order('price_<?php echo $MarkID?>')" onblur="check_value_order('price_<?php echo $MarkID?>')" class="SmallInput2" >
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input  readonly type="text" id="money_<?php echo $MarkID?>" name="money<?php echo $MarkName?>" value="<?php echo $money?>" size="10"  maxlength="57" onkeypress="check_input_num('MONEY')"onfocus="init_value_order('money_<?php echo $MarkID?>')" onblur="check_value_order('money_<?php echo $MarkID?>')" class="SmallInput2" >
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text" id="senddetailsign_<?php echo $MarkID?>" name="senddetailsign<?php echo $MarkName?>" value="<?php echo $senddetailsign?>" size="10"  maxlength="58"  onkeypress="insertRow();" class="SmallInput2" >
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text" id="freenum_<?php echo $MarkID?>" name="freenum<?php echo $MarkName?>" value="<?php echo $freenum?>" size="10"  maxlength="50"  onkeypress="insertRow();" class="SmallInput2" >
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text" id="allnum_<?php echo $MarkID?>" name="allnum<?php echo $MarkName?>" value="<?php echo $allnum?>" size="10"  maxlength="50"  onkeypress="insertRow();" class="SmallInput2" >
...
<div id="hiddenId">
      ...
      <input type="hidden" name="flagState"  value="flag?ModuleId=S14">
      <input type="hidden" name="actionStateId">
      <input type="hidden" name="s_count" value="9">
      <input type="hidden" name="dataCount" value="<?php echo $dataCount?>">
      <input type="hidden" name="StockOutType" value="4">
      <input type="hidden" name="StockIsNeg" value="1">
      <input type="hidden" name="secAdd_fieldName" value=",productid,standard,mode,plannum,price,money,senddetailsign,freenum,allnum">
      <input type="hidden" name="secAdd_fieldType" value=",CHAR,CHAR,CHAR,NUMBER,MONEY,MONEY,CHAR,CHAR,CHAR">
      <input type="hidden" name="secAdd_table" value="senddetail">
      <input type="hidden" name="secFLD_MUST_STR" value="productid,standard,mode,plannum,">
      <input type="hidden" name="secFLD_NAME_STR" value="商品名称,规格,型号,送货数量,">
      <input type="hidden" name="hidDataNo" >
      <input type="hidden" name="chinaAmt" >
</div>
</form>
<input type="button" name="btninsert" id="btninsert" class="SmallButton" value="添加明细" onClick="javascript:clickInsertRow();">&nbsp;&nbsp;&nbsp;
<input type="button" name="btnsave" id="btnsave" class="SmallButton" value="删除明细" onClick="javascript:clickDeleteRow() ;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input type="button" name="btnsave" id="btnsave" class="SmallButton" value="保存" onClick="javascript:secorderaddnew() ;">&nbsp;&nbsp;&nbsp;
  <input type="reset" name="btnlist" id="btnlist" class="SmallButton" value="重置">&nbsp;&nbsp;&nbsp;
...
<div id="hiddenDataId">
<table border="0" cellspacing="1" width="95%" class="TableBlock"   style="display:none" >
 <tr>
 <td nowrap width="40" align="center" class="TableContent">
 <input  type="hidden" name="dataNo" value="1" >
 <b>1</b></td>


 <td nowrap width="100" align="left" class="TableData">

            <input type="hidden" name="productid_id" id="id_productid_id_1_wxdid_1">
            <input type="hidden" name="productid_num" id="num_productid_id_1_wxdnum_1">
            <input type="hidden" name="productid_rate" id="num_productid_id_1_wxdrate_1">
            <input  title="请选择商品....."   type="text" id="id_productid_1_wxd_1"   name="productid" size="10"  maxlength="53"  onClick="dataClick('1'); "  class="SmallInput2" onkeypress="dataQuery('productid','S14',1);"  ondblclick="dataQuery('productid','S14',1);">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text"  id="standard_dxw" name="standard" size="10" maxlength="50"   onkeypress="insertRow();"
 class="SmallInput2">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text"  id="mode_dxw" name="mode" size="10" maxlength="50"   onkeypress="insertRow();"
 class="SmallInput2">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text" id="plannum_dxw" name="plannum" size="10"  maxlength="54" onkeypress="check_input_num('NUMBER')"onfocus="init_value_order('price_dxw')"  onblur="check_value_order('price_dxw')" class="SmallInput2" >
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text"  id="price_dxw" name="price" size="10" maxlength="56"  onkeypress="check_input_num('MONEY')"onfocus="init_value_order('price_dxw')" onblur="check_value_order('price_dxw')" class="SmallInput2">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input  readonly type="text"  id="money_dxw" name="money" size="10" maxlength="57"  onkeypress="check_input_num('MONEY')"onfocus="init_value_order('money_dxw')" onblur="check_value_order('money_dxw')" class="SmallInput2">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text"  id="senddetailsign_dxw" name="senddetailsign" size="10" maxlength="58"   onkeypress="insertRow();"
 class="SmallInput2">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text"  id="freenum_dxw" name="freenum" size="10" maxlength="50"   onkeypress="insertRow();"
 class="SmallInput2">
 ...
 <td nowrap width="100" align="left" class="TableData">
           ...
           <input   type="text"  id="allnum_dxw" name="allnum" size="10" maxlength="50"   onkeypress="insertRow();"
 class="SmallInput2">
