...
function outProduct(countStr){
 ...
 //
  URL="/getstock.jsp?codeValue="+codeValue+"&countStr="+countStr+"&cliNo="+cliNo+"&supplyId="+supplyId+"&stockId="+stockId;
   loc_x=354;
   loc_y=262;
  //alert(URL);
  window.showModalDialog(URL,self,"edge:raised;scroll:0;status:0;help:0;resizable:1;dialogWidth:700px;dialogHeight:300px;dialogTop:"+loc_y+"px;dialogLeft:"+loc_x+"px");
...
function  getBuyPlan()
{
	...
	if(value_empty("FLD_MUST_STR","FLD_NAME_STR"))
      return (false);
   var supplyId=document.form1("stockid").value;
   var ModuleId=document.form1("ModuleId").value;
   ...
   var isfax="";
   var buyman=document.form1("requireman").value;
   var issend=document.form1("stockinsign").value;
   var payment="-1";


  URL="getbuyplanfromsellplan_index.php?supplyId="+supplyId+"&ModuleId="+ModuleId+"&tablecode="+tablecode+"&tabledate="+tabledate+"&stockid="+stockid+"&intype="+intype+"&isfax="+isfax+"&buyman="+buyman+"&issend="+issend+"&payment="+payment;
   loc_x=50;
   loc_y=50;
 // alert(URL);
  //window.showModalDialog(URL,self,"edge:raised;scroll:0;status:0;help:0;resizable:1;dialogWidth:700px;dialogHeight:300px;dialogTop:"+loc_y+"px;dialogLeft:"+loc_x+"px");
 	window.open(URL,"qq","menubar=0,toolbar=0,status=0,scrollbars=1,resizable=1,width=1000px,height=550px,Top="+loc_y+"px,Left="+loc_x+"px");
...
<form name="form1" action="/GRP_StockInAddMessage" method="post">

<table width="95%" class="TableBlock">
  <tr>
    <td nowrap align="left" class="TableHeader" colspan="2">&nbsp;&nbsp;<b>销售订单生成采购计划      ：以下项目带*号的为必填项目</b></td>
    <td nowrap align="left" class="TableHeader" colspan="2">&nbsp</td>
  </tr>

   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>编号&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <input  readonly type="text" name="tablecode" value="<?php echo returnDateAutoIncrement("tablecode","sellplanmain");?>" size="15"  maxlength="50"   class="SmallInput">
<b>*</b>
       </td>

       <td nowrap width="100" align="right" class="TableContent"><b>计划日期&nbsp;</b></td>
       <td nowrap align="left" class="TableData">
...
<b>*</b>
   ...
   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>计划付款&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <input   type="text" name="factpayamt" value="<?php echo $factpayamt?>" value="<?php echo $factpayamt?>" size="15"  maxlength="50" onkeypress="check_input_num('MONEY')" onfocus="init_value('factpayamt')" onblur="check_value('factpayamt')" class="SmallInput">

       </td>

       <td nowrap width="100" align="right" class="TableContent"><b>计划类型&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <select name="intype"  class="SmallSelect">

      <option value="1" >正常采购计划</option>

      <option value="2" >临时采购计划</option>

      <option value="3" >紧急采购计划</option>
   ...
   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>已付定金&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <input   type="text" name="payamt" value="<?php echo $payamt?>" size="15"  maxlength="50" onkeypress="check_input_num('MONEY')" onfocus="init_value('payamt')" onblur="check_value('payamt')" class="SmallInput">
       ...
       <td nowrap align="left" class="TableData">
           ...
           <input   type="text" name="stockinsign" value="<?php echo $stockinsign?>" size="15"  maxlength="50"   class="SmallInput">
   ...
   <tr>
       ...
       <td nowrap align="left" class="TableData">
           ...
           <input   type="text" name="requireman" value="系统管理员" size="15"  maxlength="50"    onclick="query_user('requireman');" class="SmallInput">

       </td>

       <td nowrap width="100" align="right" class="TableContent">&nbsp</b></td>
       <td nowrap align="left" class="TableData">&nbsp</td>

   </tr>

      <input type="hidden" name="a_count" value="9">
      <input type="hidden" name="Add_fieldName" value=",tablecode,tabledate,stockid,amt,factpayamt,intype,payamt,stockinsign,requireman">
      <input type="hidden" name="Add_fieldType" value=",CHAR,DATE,CHAR,MONEY,MONEY,CHAR,MONEY,CHAR,CHAR">
      <input type="hidden" name="Add_table" value="requireplanmain">
      <input type="hidden" name="Add_url" value="sellplantobuy/add.jsp">
      <input type="hidden" name="Back_url" value="sellplantobuy/index.jsp">
      <input type="hidden" name="FLD_MUST_STR" value="tablecode,tabledate,stockid,">
      <input type="hidden" name="FLD_NAME_STR" value="编号,计划日期,需求部门,">
      <input type="hidden" name="ModuleId" value="B06">
...
<input type="button" name="btnsave" id="btnsave" class="SmallButton" value="选择销售订单" onClick="javascript:getBuyPlan();">&nbsp;&nbsp;&nbsp;
