...
function  getBuyPlan()
{
   ...
   var intype=document.form1("outtype").value;
   var isfax="";
   //if (document.getElementById("customerPO")!=null){
   //isfax=document.form1("customerPO").value;
   //}
   var buyman=document.form1("sellman").value;
   var issend=document.form1("issend").value;
   var payment=document.form1("paymentid").value;

  URL="getsellplan_index.php?supplyId="+supplyId+"&ModuleId="+ModuleId+"&tablecode="+tablecode+"&tabledate="+tabledate+"&stockid="+stockid+"&intype="+intype+"&isfax="+isfax+"&buyman="+buyman+"&issend="+issend+"&payment="+payment;
   loc_x=50;
   loc_y=50;
  //alert(URL);
  //window.showModalDialog(URL,self,"edge:raised;scroll:0;status:0;help:0;resizable:1;dialogWidth:700px;dialogHeight:300px;dialogTop:"+loc_y+"px;dialogLeft:"+loc_x+"px");
...
<table width="95%" class="TableBlock">
  <tr>
    <td nowrap align="left" class="TableHeader" colspan="2">&nbsp;&nbsp;<b>销售订单生成出库单据      ：以下项目带*号的为必填项目</b></td>
    <td nowrap align="left" class="TableHeader" colspan="2">&nbsp</td>
  </tr>

   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>出库单编号&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <input  readonly type="text" name="tablecode" value="<?php echo $_GET['tablecode']?>" size="15"  maxlength="50"   class="SmallStatic">

       </td>

       <td nowrap width="100" align="right" class="TableContent"><b>出库日期&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

          <input type="text" name="tabledate" value="2007-07-09" readonly  class="SmallStatic">
...
<b>*</b>
   ...
   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>出库类型&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

<?php
		print_select_single_select2("outtype",'03',"outtype","id","name",$outtype);
	?>
       </td>

       <td nowrap width="100" align="right" class="TableContent"></td>
       <td nowrap align="left" class="TableData">
   ...
   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>折扣&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <input   type="text" name="rebate"  size="10"  maxlength="50" onkeypress="check_input_num('NUMBER')" value='10'  class="SmallInput">
<b>*</b>
       </td>
       ...
       <td nowrap align="left" class="TableData">
           ...
           <input   type="text" name="isfax" value="" size="10"  maxlength="50" onkeypress="check_input_num('NUMBER')"  class="SmallInput">
   ...
   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>是否送货&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <select name="issend"  class="SmallSelect">

      <option value="0" >送货</option>

      <option value="1" >不送</option>
...
<?php
	...
	?>
       ...
       <td nowrap align="left" class="TableData">
          ...
          <input   type="text" name="sellman_NAME" value="<?php echo returntablefield("user","USER_NAME",$buyman,"NICK_NAME");?>" size="15"  maxlength="50"   onclick="query_user('sellman');"  class="SmallInput">
      ...
      <input type="hidden" name="a_count" value="20">
      <input type="hidden" name="Add_fieldName" value="tablecode,tabledate,supplyid,stockid">
      <input type="hidden" name="Add_fieldType" value="CHAR,DATE,CHAR,CHAR">
      <input type="hidden" name="Add_table" value="stockoutmain">
      <input type="hidden" name="Add_url" value="plantoout/add.php">
      <input type="hidden" name="Back_url" value="plantoout/index.php">
      <input type="hidden" name="FLD_MUST_STR" value="tabledate,supplyid,stockid">
      <input type="hidden" name="FLD_NAME_STR" value="出库日期,客户,仓库名称">
      <input type="hidden" name="ModuleId" value="S04">
