...
function  getRequirePlan()
{
  ...
  URL="getrequirein_index.php?supplyId="+supplyId+"&ModuleId="+ModuleId+"&tablecode="+tablecode+"&tabledate="+tabledate+"&stockid="+stockid+"&intype="+intype+"&isfax="+isfax+"&buyman="+buyman+"&stockinsign="+stockinsign;
   loc_x=60;
   loc_y=100;
  //alert(URL);
  //window.showModalDialog(URL,self,"edge:raised;scroll:0;status:0;help:0;resizable:1;dialogWidth:700px;dialogHeight:300px;dialogTop:"+loc_y+"px;dialogLeft:"+loc_x+"px");
...
<table width="95%" class="TableBlock">
  <tr>
    <td nowrap align="left" class="TableHeader" colspan="2">&nbsp;&nbsp;<b>采购计划单据生成入库单据管理      ：以下项目带*号的为必填项目</b></td>
...
<b>*</b>
       ...
       <td nowrap width="100" align="right" class="TableContent"><b>实际应付款&nbsp;</b></td>
       <td nowrap align="left" class="TableData">
   ...
   <tr>
       ...
       <td nowrap align="left" class="TableData">
           ...
           <input   type="text" name="stockinsign" value="<?php echo $stockinsign?>" size="30"  maxlength="50"   class="SmallInput">

       </td>

       <td nowrap width="100" align="right" class="TableContent"><b>运费&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <input   type="text" name="sendAmt" value="<?php echo $sendAmt?>" size="15"  maxlength="50" onkeypress="check_input_num('MONEY')" onfocus="init_value('sendAmt')" onblur="check_value('sendAmt')" class="SmallInput">
   ...
   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>到货日期&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

          <input type="text" name="todate" value="<?php echo $todate?>" readonly  class="SmallStatic">
          <input type="button" name="b1" value="浏览" class="SmallButton" onclick="query_date('todate');">
   ...
   <tr>
       <td nowrap width="100" align="right" class="TableContent"><b>原始编号&nbsp;</b></td>
       <td nowrap align="left" class="TableData">

           <input   type="text" name="tableNo" size="15"  maxlength="50"   class="SmallInput">
      ...
      <input type="hidden" name="Add_fieldName" value=",tablecode,tabledate,supplyid,amt,stockid,factpayamt,intype,payamt,stockinsign,sendAmt,isfax,noFaxAmt,todate,buyman,tableNo">
      ...
      <input type="hidden" name="Add_url" value="requireplantoin/add.php">
      <input type="hidden" name="Back_url" value="requireplantoin/index.php">
      <input type="hidden" name="FLD_MUST_STR" value="tablecode,tabledate,supplyid,stockid,">
      <input type="hidden" name="FLD_NAME_STR" value="入库单编号,入库日期,供应商,仓库名称,">
...
systemhelpContent("采购入库生成管理",'100%');
?>
