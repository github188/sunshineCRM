<?php
	...
	*/
	$SYSTEM_ADD_SQL=" and mainrowid in (select billid from buyplanmain where user_flag>=1)";
	
	//数据表模型文件,对应Model目录下面的buyplanmain_detail_newai.ini文件
	//如果是需要复制此模块,则需要修改$parse_filename参数的值,然后对应到Model目录 新文件名_newai.ini文件
	$filetablename		=	'buyplanmain_detail';
	$parse_filename		=	'buyplanmain_detail';
