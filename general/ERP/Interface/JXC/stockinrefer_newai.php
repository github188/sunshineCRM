...
$parse_filename = 'stockinrefer';
require_once('include.inc.php');

systemhelpContent("入库退货操作说明",'100%');
...
function StockInToReferData($Rowid)			{
	global $db;
	$SystemRowid = $Rowid;
	...
	$sql = "update stockinmain set tableNo='1' where ROWID='$SystemRowid'";
	$db->Execute($sql);
...
<tr align="left" >
<td nowrap  class="TableContent" colspan=8>入库单据号码：<?php echo $tablecode?></td>
</tr>
<tr align="center" >
...
<td   align="left" ><input readonly  type="text"   name="4<?php echo $ii?>" value="<?php echo $stockindetailsign?>" size="10" maxlength="54"  class="SmallInput2"></td>
