...
function CustomerChancePriv_add($fields, $i )
{
...
function changelocation(locationid)
{
	...
	if(locationid!='')
    	sendRequest('chance','customerid='+locationid);
}
";
...
print "<SELECT id=$fieldname2 onkeydown=\"if(event.keyCode==13)event.keyCode=9\" class=\"$class\" \n";
print "size=1 name=$fieldname2>\n";
