<?php
	...
	*/
	...
	//数据表模型文件,对应Model目录下面的wu_cheweizhuangtai_newai.ini文件
	//如果是需要复制此模块,则需要修改$parse_filename参数的值,然后对应到Model目录 新文件名_newai.ini文件
	$filetablename		=	'wu_cheweizhuangtai';
	$parse_filename		=	'wu_cheweizhuangtai';
	...
	if($_GET['action']==''||$_GET['action']=='init_default'||$_GET['action']=='init_customer')		{
		...
		说明：<BR>
		&nbsp;&nbsp;&nbsp;&nbsp;1 此页面的数据都是基础数据。<BR>
		&nbsp;&nbsp;&nbsp;&nbsp;2 如果需要删除或者增加规则设置，请联系管理员或技术人员。<BR>
		&nbsp;&nbsp;&nbsp;&nbsp;3 如果随意更改或者删除数据，有可能造成系统终止运行或故障。
		</font></td></table>";
		print $PrintText;
	}
	?>