...
//#########################################################
$jumpclassroominfor = "选择所有部门弹出框";
function jumpbumeninfor_add($fields,$i)		{
	global $db;
	...
	print "<a href=\"javascript:;\" class=\"orgAdd\" onClick=\"SelectAllInforSingle('../../Enginee/Module/bumen_select_single/index.php','','$fieldname', '$fieldnameID')\">选择</a>\n";
