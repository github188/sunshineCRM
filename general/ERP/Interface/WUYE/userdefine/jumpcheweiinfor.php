...
//#########################################################
$jumpclassroominfor = "选择所有停车场弹出框";
function jumpcheweiinfor_add($fields,$i)		{
	global $db;
	...
	print "<a href=\"javascript:;\" class=\"orgAdd\" onClick=\"SelectAllInforSingle('../../Enginee/Module/chewei_select_single/index.php','','$fieldname', '$fieldnameID')\">选择</a>\n";
