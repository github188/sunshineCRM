<?php
	...
	*/
	...
	//数据表模型文件,对应Model目录下面的wu_propertycostsset_newai.ini文件
	//如果是需要复制此模块,则需要修改$parse_filename参数的值,然后对应到Model目录 新文件名_newai.ini文件
	$filetablename		=	'wu_propertycostsset';
	$parse_filename		=	'wu_propertycostsset';
	...
	if($_GET['action']==''||$_GET['action']=='init_default'||$_GET['action']=='init_customer')		{
			...
			说明：<BR>
			&nbsp;&nbsp;&nbsp;&nbsp;1 本页面设置除水、电、气、公摊水、公摊电以外的所有费用。<BR>
			&nbsp;&nbsp;&nbsp;&nbsp;2 设置费用名称和其对应的单价，收费规则，以及说明。<BR>
			&nbsp;&nbsp;&nbsp;&nbsp;3 本页面的规则数据将在物业收费明细页面进行应用以及计算。<BR>
			</font></td></table>";
			print $PrintText;
		}
	?>