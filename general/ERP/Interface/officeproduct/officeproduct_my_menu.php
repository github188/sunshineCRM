...
$MenuArray[] = array("officeproduct_my_jieyou.php","借用明细","借用明细");
$MenuArray[] = array("officeproduct_my_lingyou.php","领用明细","领用明细");
$MenuArray[] = array("officeproduct_my_guihuan.php","归还明细","归还明细");
$MenuArray[] = array("officeproduct_my_ruku.php","入库明细","入库明细");
$MenuArray[] = array("officeproduct_my_tiaoku.php","调库明细","调库明细");
$MenuArray[] = array("officeproduct_my_baofei.php","报废明细","报废明细");
