...
<script src="<?php echo ROOT_DIR?>inc/js/hover_tr.js"></script>
	...
	if(key!=kword.value && kword.value!="")
	{
     key=kword.value;
	   ...
	   if($('search_icon').src.indexOf("/images/quicksearch.gif")>=0)
	   {
	   	   ...
	   	   $('search_icon').onclick=function(){kword.value='按办公用品类别名称搜索...';$('search_icon').src="../../../Framework/images/quicksearch.gif";$('search_icon').title="";$('search_icon').onclick=null;};
	   }
  }
...
<div style="border:1px solid #000000;margin-left:2px;background:#FFFFFF;">
  <input type="text" id="kword" name="kword" value="按办公用品类别名称搜索..." onfocus="ctroltime=setTimeout(CheckSend,100);" onblur="clearTimeout(ctroltime);if(this.value=='')this.value='按办公用品类别名称搜索...';" class="SmallInput" style="border:0px; color:#A0A0A0;width:145px;"><img id="search_icon" src="../../../Framework/images/quicksearch.gif" align=absmiddle style="cursor:pointer;">
</div>
