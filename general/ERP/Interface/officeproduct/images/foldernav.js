...
function linew(){
with(document){
  write("<img src=images/I.gif align=absmiddle border='0'><img src=images/T.gif align=absmiddle border='0'><img src=images/htmlicon.gif align=absmiddle border='0'>");	
}
}

function elinew(){
with(document){
  write("<img src=images/white.gif align=absmiddle border='0'><img src=images/T.gif align=absmiddle border='0'><img src=images/htmlicon.gif align=absmiddle border='0'>");	
}
}

function e2linew(){
with(document){
  write("<img src=images/white.gif align=absmiddle border='0'><img src=images/L.gif align=absmiddle border='0'><img src=images/htmlicon.gif align=absmiddle border='0'>");	
}
}
