...
//#########################################################
$jumpclassroominfor = "选择所有银行账户弹出框";
function jumpzhanghuinfor_add($fields,$i)		{
	global $db;
	...
	print "<a href=\"javascript:;\" class=\"orgAdd\" onClick=\"SelectAllInforSingle('../../Enginee/Module/zhanghu_select_single/index.php','','$fieldname', '$fieldnameID')\">选择</a>\n";
