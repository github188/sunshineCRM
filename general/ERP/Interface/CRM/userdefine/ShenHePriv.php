...
function ShenHePriv_value( $fieldvalue, $fields, $i )
{
				return $fieldvalue;
}

function ShenHePriv_value_PRIV( $fieldvalue, $fields, $i )
{
		
//print_R($fields['value'][$i]);
				$userinfo = returntablefield( "user", "user_id", $fields['value'][$i]['录单员'], "user_id,dept_id,user_priv" );
