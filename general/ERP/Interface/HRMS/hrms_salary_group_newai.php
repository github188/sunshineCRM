...
$SYSTEM_PRIV_STOP = 1;
	...
	*/
	...
	//数据表模型文件,对应Model目录下面的hrms_salary_group_newai.ini文件
	//如果是需要复制此模块,则需要修改$parse_filename参数的值,然后对应到Model目录 新文件名_newai.ini文件
	$filetablename		=	'hrms_salary_group';
	$parse_filename		=	'hrms_salary_group';
