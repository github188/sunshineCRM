...
$TARGET_TITLE = "人力资源-日常费用";

$TARGET_ARRAY = $PRIVATE_SYSTEM['人力资源']['日常费用'];
...
<frameset rows="30,*"  cols="*" frameborder="0" border="0" framespacing="0" id="frame1">
    <frame name="file_title" scrolling="no" noresize src="MAIN_FEIYONG_MENU.php" frameborder="0">
