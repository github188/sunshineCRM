...
$SYSTEM_PRIV_STOP = 1;
	...
	CheckSystemPrivate("人力资源-薪酬管理-我的工资福利");
	$_GET['费用人员'] = $_SESSION['LOGIN_USER_NAME'];
	...
	*/
	...
	//数据表模型文件,对应Model目录下面的hrms_salary_detail_newai.ini文件
	//如果是需要复制此模块,则需要修改$parse_filename参数的值,然后对应到Model目录 新文件名_newai.ini文件
	$filetablename		=	'hrms_salary_detail';
	$parse_filename		=	'hrms_salary_detail';
