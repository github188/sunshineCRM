...
$TARGET_ARRAY = $PRIVATE_SYSTEM['后勤管理'];
...
<frameset rows="30,*"  cols="*" frameborder="0" border="0" framespacing="0" id="frame1">
    <frame name="file_title" scrolling="no" noresize src="MAIN_HOUQIN_MENU.php" frameborder="0">
    <frame name="edu_main" scrolling="auto" src="<?php echo $fileName ?>" frameborder="0">
</frameset>
