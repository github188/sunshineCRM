...
<frameset rows="30,*"  cols="*" frameborder="0" border="0" framespacing="0" id="frame1">
    <frame name="file_title" scrolling="no" noresize src="my_fixedasset_menu.php" frameborder="0">
    <frame name="menu_main_frame" scrolling="auto" src="fixedasset_my_newai.php" frameborder="0">
</frameset>