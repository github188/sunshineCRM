...
$TARGET_TITLE = "后勤管理-固定资产";

$TARGET_ARRAY = $PRIVATE_SYSTEM['后勤管理']['固定资产'];
...
<frameset rows="30,*"  cols="*" frameborder="0" border="0" framespacing="0" id="frame1">
    <frame name="file_title" scrolling="no" noresize src="MAIN_FIXEDASSET_MENU.php" frameborder="0">
