<?php
	...
	CheckSystemPrivate("后勤管理-公物维修-类型设置");
	...
	*/
	...
	//数据表模型文件,对应Model目录下面的wygl_biaoxiuxiangmu_newai.ini文件
	//如果是需要复制此模块,则需要修改$parse_filename参数的值,然后对应到Model目录 新文件名_newai.ini文件
	$filetablename		=	'wygl_biaoxiuxiangmu';
	$parse_filename		=	'wygl_biaoxiuxiangmu';
