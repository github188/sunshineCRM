...
<?php
	...
	else if($_GET['action']=="")
	{
		...
		$楼房属性_sel = "<Select name='楼房属性' class=SmallSelect style='width:50%;' onChange=\"var jmpURL='?flag=jump&楼房属性=' + this.options[this.selectedIndex].value; if(jmpURL!='') {window.location=jmpURL;} else {this.selectedIndex=0;}\">";
		...
		$rs_a = array();
		$楼房名称 = $rs_a;
		$楼房名称_sel = "<Select class=SmallSelect name='楼房名称' style='width:50%;'>";
		...
		$楼房名称_sel .= "</Select>";
					...
					//********楼房地址********//
		$楼房地址_inp = "<Input class=SmallInput id='address' name='楼房地址' style='width:50%;'></Input>";
		...
		$rs = $db -> Execute($sql);
		$报修项目 = $rs -> GetArray();
		$报修项目_sel = "<Select name='报修项目' class=SmallSelect style='width:50%;'>";
		...
		print "<Tr class=TableData><Td width=25% align=center>楼房属性:</Td><Td width=25% align=left>&nbsp;&nbsp;".$楼房属性_sel."</Td><Td width=25% align=center>楼房名称:</Td><Td width=25% align=left>&nbsp;&nbsp;".$楼房名称_sel."</Td></Tr>";
		print "<Tr class=TableData><Td width=25% align=center>楼房地址:</Td><Td width=25% align=left>&nbsp;&nbsp;".$楼房地址_inp."</Td><Td width=25% align=center>报修项目:</Td><Td width=25% align=left>&nbsp;&nbsp;".$报修项目_sel."</Td></Tr>";
		print "<Tr class=TableData><Td width=25% align=center>报修人联系方式:</Td><Td  colspan=3 align=left>&nbsp;&nbsp;<input size=25 type=input class=SmallInput name=报修人联系方式 value='$报修人联系方式'>(默认为用户的手机号)</Td></Tr>";
		print "<Tr class=TableData><Td align=center>报修内容</Td><Td colspan=3 align=left>&nbsp;&nbsp;".$报修内容_tex."</Td></Tr>";
		print "</Table><Br>";
