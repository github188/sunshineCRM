...
//#########################################################
$xianghutiaobanworkflowtodetail = "工作流ID号到工作流明细页面";
//#########################################################
function xianghutiaobanworkflowtodetail_Value($fieldvalue,$fields,$i)		{
	global $db;
	...
	{	
		...
		if($审核人 == "")
		{
			...
			$工作流ID号 = 
			"<a href=\"?action2=TiaoKeDelete&编号=$编号\">删除此条记录</a>";	
		}
		else if($审核人 != "" )
		{
			if($是否 == "是")
