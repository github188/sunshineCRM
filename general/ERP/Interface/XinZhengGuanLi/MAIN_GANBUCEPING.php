...
$TARGET_TITLE = "人力资源-干部测评";

$TARGET_ARRAY = $PRIVATE_SYSTEM['人力资源']['干部测评'];
...
<frameset rows="30,*"  cols="*" frameborder="0" border="0" framespacing="0" id="frame1">
    <frame name="file_title" scrolling="no" noresize src="MAIN_GANBUCEPING_MENU.php" frameborder="0">
