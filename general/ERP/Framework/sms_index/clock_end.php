...
<b>
<form name=form1>
<?php echo $framework_html[$choose_lang]['Time']?>：<select name=hour class=BigSelect style="width:50px">
...
<br>
<br>
<input type=button  onClick="check_form();" value="<?php echo $framework_html[$choose_lang]['Sure']?>" title="<?php echo $framework_html[$choose_lang]['Sure']?>" class="BigButton">
</form>
</b>
</div>
