...
function check_form()
{
    var date_time=parent_window.form1.<?php echo $datetime?>.value;
    var cur_time=form1.hour.value+":"+form1.minite.value+":"+form1.second.value;
    parent_window.form1.<?php echo $datetime?>.value=parent_window.form1.<?php echo $datetime?>.value.substring(0,10)+" "+cur_time;
    window.close();
}
</script>

<LINK href="../../../../theme/<?php echo $_SESSION['LOGIN_THEME']?>/style.css\" rel=stylesheet>
...
<b>
<form name=form1>
时间：<select name=hour class=BigSelect style="width:50px">
...
<br>
<br>
<input type=button  onClick="check_form();" value="确定" class="BigButton">
</form>
</b>
</div>
