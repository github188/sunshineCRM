...
function newai_dataline( $modulename, $functionname = "dataline_view" )
{
				...
				case "url_dataline_view" :
								...
								$rs_a = $rs->getarray( );
								$listheader = $common_html['common_html']['all'].$common_html['common_html'][$tablename];
								break;
				case "dataline_view" :
				...
				$functionname( $list, $listheader );
}

function dataline_view( $list, $listheader )
{
				global $SUNSHINE_USER_NAME_VAR;
				global $SUNSHINE_USER_ID_VAR;
				global $_SESSION;
				...
				{
								if ( $link_array[0] == "calendar_newai.php" )
								{
												$list['bottom'] = "<a href=\"../Interface/OA2/calendar/\"><img src=\"images/green_arrow.gif\" border=\"0\" align=\"absmiddle\">{$listheader}</a>";
								}
								else
								{
												$list['bottom'] = "<a href=\"".$link_array[0]."\"><img src=\"images/green_arrow.gif\" border=\"0\" align=\"absmiddle\">{$listheader}</a>";
								}
				}
				else
				{
								$list['bottom'] = "<img src=\"images/green_arrow.gif\" border=\"0\" align=\"absmiddle\">{$listheader}";
				}
				print "\r\n<TABLE class=small cellSpacing=1 cellPadding=3 width=".$list['width']." bgColor=#000000 \r\nborder=0>\r\n<TBODY>\r\n<TR class=TableControl>\r\n<td class=\"TableHeader\" width=\"70%\">\r\n<img src=\"images/menu/".$list['tablename'].".gif\" WIDTH=\"16\" HEIGHT=\"16\" align=\"absmiddle\"> ".$list['header']['name']."&nbsp;</TD>\r\n<td align=right nowrap> ".$list['bottom']."&nbsp;</td>\r\n</TR>\r\n<TR class=TableData>\r\n<TD noWrap colspan=2>";
				if ( sizeof( $list['body'] ) == 0 )
				{
